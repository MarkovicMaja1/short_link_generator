...
const shortUtl_1 = require("../model/shortUtl");
const createUrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("The fullUrl is ", req.body.fullUrl);
        const { fullUrl } = req.body;
        const urlFound = yield shortUtl_1.urlModel.find({ fullUrl });
        if (urlFound.length > 0) {
            res.status(409);
            res.send(urlFound);
        }
        else {
            const shortUrl = yield shortUtl_1.urlModel.create({ fullUrl });
...
const getAllUrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const shortUrls = yield shortUtl_1.urlModel.find().sort({ createdAt: -1 });
...
const getUrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const shortUrl = yield shortUtl_1.urlModel.findOne({ shortUrl: req.params.id });
        if (!shortUrl) {
...
const deleteUrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const shortUrl = yield shortUtl_1.urlModel.findByIdAndDelete({ _id: req.params.id });
        if (shortUrl) {
